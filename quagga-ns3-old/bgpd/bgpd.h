...
#define BGP_MSG_TRUST_MIN_SIZE                  (BGP_HEADER_SIZE + 0)
#define BGP_MSG_VOTING_PEERS_REQUEST_MIN_SIZE   (BGP_HEADER_SIZE + 0)
#define BGP_MSG_VOTING_PEERS_RESPONSE_MIN_SIZE  (BGP_HEADER_SIZE + 0)
#define BGP_MSG_VOTING_VOTE_REQUEST_MIN_SIZE    (BGP_HEADER_SIZE + 0)
#define BGP_MSG_VOTING_VOTE_RESPONSE_MIN_SIZE   (BGP_HEADER_SIZE + 0)
...
#define	BGP_MSG_TRUST	                      7
#define	BGP_MSG_VOTING_PEERS_REQUEST        8
#define	BGP_MSG_VOTING_PEERS_RESPONSE       9
#define	BGP_MSG_VOTING_VOTE_REQUEST	        10
#define	BGP_MSG_VOTING_VOTE_RESPONSE	      11
